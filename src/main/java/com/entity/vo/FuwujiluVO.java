...
public class FuwujiluVO  implements Serializable {
	...
	public void setFuwuqingkuang(String fuwuqingkuang) {
		this.fuwuqingkuang = fuwuqingkuang;
	}
	
	/**
	 * 获取：服务情况
	 */
	public String getFuwuqingkuang() {
		return fuwuqingkuang;
	}
