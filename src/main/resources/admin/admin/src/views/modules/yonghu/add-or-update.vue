		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="折扣" prop="zhekou" >
					<el-input-number v-model="ruleForm.zhekou" placeholder="折扣" :disabled="ro.zhekou"></el-input-number>
				</el-form-item>
				<el-form-item v-else class="input" label="折扣" prop="zhekou" >
					<el-input v-model="ruleForm.zhekou" placeholder="折扣" readonly></el-input>
				</el-form-item>
