		...
		<template v-if="showFlag">
			...
			<div :style='{"width":"100%","padding":"0px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true' v-if="isAuth('fuwupingjia','审核')" prop="sfsh" label="回复">
						<template slot-scope="scope">
	...
	export default {
		...
		methods: {
			...
			getDataList() {
				...
				if(this.searchForm.fuwuxiaolv!='' && this.searchForm.fuwuxiaolv!=undefined){
					params['fuwuxiaolv'] = this.searchForm.fuwuxiaolv
				}
				if(this.searchForm.fuwutaidu!='' && this.searchForm.fuwutaidu!=undefined){
					params['fuwutaidu'] = this.searchForm.fuwutaidu
				}
				if(this.searchForm.fuwuzhiliang!='' && this.searchForm.fuwuzhiliang!=undefined){
					params['fuwuzhiliang'] = this.searchForm.fuwuzhiliang
				}
			...
			shDialog(row){
				...
				if(row){
					this.shForm = {
						...
						fuwushizhang: row.fuwushizhang,
						fuwutupian: row.fuwutupian,
						fuwuxiaolv: row.fuwuxiaolv,
						fuwutaidu: row.fuwutaidu,
						fuwuzhiliang: row.fuwuzhiliang,
						pingjiajianyi: row.pingjiajianyi,
