	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item v-else class="input" label="服务电话" prop="fuwudianhua" >
			...
			<el-form-item v-else-if="ruleForm.fuwujieshao" label="服务介绍" prop="fuwujieshao" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.fuwujieshao"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.fuwujieshao = this.ruleForm.fuwujieshao.replace(reg,'../../../springbootmwrnnvi8/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
