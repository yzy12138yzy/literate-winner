	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="工作经验" prop="gongzuojingyan" >
					<el-input v-model="ruleForm.gongzuojingyan" placeholder="工作经验" clearable  :readonly="ro.gongzuojingyan"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="工作经验" prop="gongzuojingyan" >
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `baojieayi/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.baojieayiCrossAddOrUpdateFlag = false;
											this.parent.search();
