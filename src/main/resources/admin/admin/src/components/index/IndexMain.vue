<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"20px 20px 0 220px","margin":"0","position":"relative","background":"#f6f6f6","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 1px 6px rgba(0, 0, 0, .3)","padding":"0px 10px 0 0","alignItems":"center","display":"block","justifyContent":"flex-end","top":"0","borderRadius":"10px","left":"20px","background":"#00ad45","width":"calc(100% - 20px)","fontSize":"16px","position":"inherit","zIndex":"1001","height":"70px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"width":"calc(100% - 20px)","padding":"20px 10px","margin":"0px auto 0 20px","background":"none"}' class="bread-crumbs"></bread-crumbs>
