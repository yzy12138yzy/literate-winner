<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item"  label="服务效率" prop="fuwuxiaolv">
				<el-select v-model="ruleForm.fuwuxiaolv" placeholder="请选择服务效率" :disabled=" false  ||ro.fuwuxiaolv" >
					<el-option
			...
			<el-form-item class="add-item"  label="服务态度" prop="fuwutaidu">
				<el-select v-model="ruleForm.fuwutaidu" placeholder="请选择服务态度" :disabled=" false  ||ro.fuwutaidu" >
					<el-option
			...
			<el-form-item class="add-item"  label="服务质量" prop="fuwuzhiliang">
				<el-select v-model="ruleForm.fuwuzhiliang" placeholder="请选择服务质量" :disabled=" false  ||ro.fuwuzhiliang" >
					<el-option
			...
			<el-form-item class="add-item" label="评价建议" prop="pingjiajianyi">
				<el-input
					type="textarea"
					:rows="8"
					placeholder="评价建议"
			...
			async onSubmit() {
				await this.$refs["ruleForm"].validate(async valid => {
					if(valid) {
						...
						await this.$http.post(`fuwupingjia/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(async res => {
							if (res.data.code == 0) {
								this.$message({
									message: '操作成功',
									type: 'success',
